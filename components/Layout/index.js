...
const LayoutContent = ( props ) => {
	const { children, breadcrumb, pageHeaderContent, ...pageHeaderProps } = props;
	...
	const headerProps = pickBy( {
		breadcrumb: breadcrumb ? { routes: breadcrumb, itemRender } : false,
		...pageHeaderProps,
	}, identity );
	if ( pageHeaderContent ) {
		headerProps.children = pageHeaderContent;
	}
